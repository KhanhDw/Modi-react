      ...
      >
        <div className="flex items-center justify-between p-4 mx-auto max-w-full">
          ...
          <div className="flex items-center space-x-2 md:space-x-4 flex-shrink-0">
            ...
            <NavLink to="/managers/profile" className="hidden md:block">
              <Button
                variant="ghost"
              ...
              >
                ...
                <span className="text-sm font-bold">{username || "Khách"}</span>
              </Button>
            </NavLink>
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 z-50 bg-white admin-dark:bg-slate-900 flex flex-col p-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-gray-800 admin-dark:text-gray-100">Tìm kiếm</h2>
            <Button
              variant="ghost"
              size="icon"
