export const skeleton = {
  container:
    "hidden md:block w-full p-3 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-950 rounded-3xl shadow-xl",
  tableWrapper:
  ...
  stageRow: "flex",
  stageHeaderCell:
    "py-4 px-4 sm:py-5 sm:px-6 bg-slate-50 dark:bg-slate-800 sticky left-0 z-30 w-[120px] sm:w-[180px] lg:w-[200px] min-w-[120px] sm:min-w-[180px] lg:min-w-[200px] border-r border-b-2 border-slate-200 dark:border-slate-700 first:rounded-tl-2xl",
  stageHeaderPulse:
    "h-7 sm:h-8 lg:h-9 bg-slate-200 dark:bg-slate-700 rounded-lg w-3/4 animate-pulse",
  stageDataCell:
    "py-4 px-4 sm:py-5 sm:px-6 bg-slate-50 dark:bg-slate-800 min-w-[160px] lg:min-w-[170px] border-b-2 border-slate-200 dark:border-slate-700 last:rounded-tr-2xl",
  stageDataPulse:
    "h-7 sm:h-8 lg:h-9 bg-slate-200 dark:bg-slate-700 rounded-lg w-2/3 mx-auto animate-pulse",
...
export const errorState = {
  container:
    "hidden md:flex flex-col items-center justify-center p-8 sm:p-10 lg:p-12 bg-red-50 dark:bg-red-950/20 border-2 border-red-200 dark:border-red-800 rounded-2xl shadow-xl max-w-lg lg:max-w-xl mx-auto my-10",
...
export const missingDataState = {
  container:
    "hidden md:flex flex-col items-center justify-center p-8 sm:p-10 lg:p-12 bg-amber-50 dark:bg-amber-950/20 rounded-2xl shadow-xl border-2 border-amber-200 dark:border-amber-800 max-w-2xl lg:max-w-3xl mx-auto my-10",
...
export const invalidDataState = {
  container:
    "hidden md:flex flex-col items-center justify-center p-8 sm:p-10 lg:p-12 bg-blue-50 dark:bg-blue-950/20 rounded-2xl shadow-xl border-2 border-blue-200 dark:border-blue-800 max-w-2xl lg:max-w-3xl mx-auto my-10",
  iconWrapper: "relative mb-6",
  iconBlur:
...
export const tableStyles = {
  ...
  thead: "text-sm sticky top-0 z-20 bg-white dark:bg-slate-900",
  stageHeaderRow: "",
  stageHeaderCell:
    "py-4 px-4 sm:py-5 sm:px-6 text-left font-bold text-sm sm:text-base md:text-lg text-slate-700 dark:text-slate-300 bg-gray-100 dark:bg-gray-800 sticky left-0 z-40 w-[120px] min-w-[120px] sm:w-[180px] sm:min-w-[180px] lg:w-[200px] lg:min-w-[200px] shadow-sm first:rounded-tl-2xl",
