...
import { FaEye, FaEnvelope, FaEyeSlash, FaFacebook, FaGoogle } from 'react-icons/fa';
                ...
                <form>
                    ...
                    <div className="mb-4 relative">
                        <input
                            ...
                            className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-[#5d5fef] focus:border-transparent transition duration-150"
                            required
                        />
                    ...
                    <div className="mb-4 relative">
                        <input
                            ...
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-[#5d5fef] focus:border-transparent transition duration-150"
                            required
                        />
                        <div
                    ...
                    <div className="flex justify-between items-center mb-6 text-sm">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                type="checkbox"
                                className="w-4 h-4 bg-transparent checked:bg-[#5d5fef] checked:border-[#5d5fef] text-white dtransition duration-150"
                            />
                            Remember me
                        </label>
