    ...
    return (
        <div className="p-4 sm:p-6 max-w-7xl mx-auto">
            <div className="bg-white rounded-xl shadow-md">
                {/* Header */}
                <div className="flex flex-col md:flex-row justify-between items-center px-4 py-4 border-b">
                    ...
                    <div className="relative w-full sm:w-64 mt-3 md:mt-0">
                        <input
                            ...
                            className="pl-10 pr-4 py-2 w-full rounded-full border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-gray-50"
                        />
                ...
                {/* Table */}
                <div className="overflow-x-auto min-h-[380]">
                    <table className="min-w-full text-sm text-gray-700">
                        ...
                        <tbody>
                            {paginated.length > 0 ? (
                                <>
                                    {paginated.map((item) => (
                                        <tr key={item.id} className="hover:bg-gray-50 transition h-16">
                                ...
                                <>
                                    <tr className="h-24 text-center">
                                        <td colSpan="5" className="text-gray-400 py-10">
                                            No results found.
                                        </td>
                                    </tr>
                                    {/* Fill empty rows to match height */}
                ...
                {/* Footer Pagination */}
                <div className="flex flex-col sm:flex-row justify-between items-center px-4 py-4 text-sm text-gray-500 gap-4">
                    <span>
