...
//         >
//           <span
//             className="admin-dark:text-gray-400 text-gray-500 truncate block max-w-[calc(100%-24px)]"
//           >
//             {selectedBank
...
//       <PopoverContent
//         className={`
//           w-[400px] p-0 border border-black/30 bg-white text-black
...
//             <CommandEmpty className="px-4 py-2 text-sm text-gray-500 admin-dark:text-gray-400">
