  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Bài đăng tháng này</CardTitle>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Tăng trưởng followers</CardTitle>
            <CardDescription>Số lượng followers theo thời gian</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Lượt tương tác hàng tháng</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Phân bố nền tảng</CardTitle>
            <CardDescription>Tỷ lệ tương tác theo nền tảng</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top bài đăng có tương tác cao</CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>So sánh hiệu suất các tài khoản mạng xã hội</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div key={index} className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <Progress value={(account.posts / 30) * 100} className="h-2" />
                  </div>
                </div>
              </div>
            ))}
