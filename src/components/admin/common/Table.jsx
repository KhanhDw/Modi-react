            ...
            {data.length === 0 ? (
              <tr>
                <td
                  ...
                  className="px-1 sm:px-2 md:px-4 py-8 sm:py-10 md:py-12 text-center text-gray-500 admin-dark:text-gray-400"
                >
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-400 admin-dark:text-gray-500 mt-1">
                      Chưa có thông tin nào được tìm thấy
                    </span>
                  </div>
                </td>
              </tr>
                  ...
                  <td className="px-1 sm:px-2 md:px-4 py-2 sm:py-3 md:py-4 text-center">
                    <div className="flex items-center justify-center space-x-1 sm:space-x-2 md:space-x-3 flex-wrap">
                      {onView && (
                        ...
                        >
                          <svg
                            className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover/btn:scale-110 transition-transform"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
