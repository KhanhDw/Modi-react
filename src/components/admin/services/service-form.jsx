        ...
        <Card className="bg-white w-full mx-auto">
          <CardHeader className="relative">
            <CardTitle className="flex gap-2 items-center">
              ...
              {editingService
                ? "Chỉnh sửa dịch vụ và bài viết"
                : "Tạo dịch vụ mới và bài viết"}
            </CardTitle>
            <CardDescription className="text-black/50">
              {editingService
                ? "Cập nhật thông tin dịch vụ và bài viết liên quan"
                : "Điền thông tin để tạo dịch vụ mới và bài viết liên quan"}
            </CardDescription>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-between gap-6">
                  ...
                  <div className="space-y-2 flex-1/3">
                    ...
                    <Input
                      className="text-black border border-black/30"
                      id="price"
                      value={editingService ? "10" : formData.price}
                    ...
                    <div className="space-y-2 pt-4">
                          ...
                          <div className="grid grid-cols-2 gap-4 pt-2">
                            ...
                            <div className="space-y-">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  handleChangeForArticle("link", e.target.value)
                                }
                      ...
                      <div className="flex gap-2 pt-4">
                        <Button
                          type="button"
                          variant="outline"
                          onClick={() => handleSubmitParagraph(selectedType)}
                        >
                          Thêm
                        </Button>
              ...
              <div className="flex gap-3">
                <Button type="submit" className="flex-1 hover:bg-gray-500/25">
                  {editingService
                    ? "Cập nhật dịch vụ và bài viết"
                    : "Tạo dịch vụ và bài viết"}
                </Button>
                <Button
                  type="button"
                  variant="outline"
