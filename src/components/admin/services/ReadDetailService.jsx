      ...
      <div className="w-full flex justify-between items-center mb-6">
        <div className="w-full flex items-center gap-2 justify-between">
          <Button
            variant="outline"
            onClick={() => navigate(-1)}
            className="flex items-center text-black hover:text-gray-900  admin-dark:bg-gray-800 admin-dark:hover:bg-gray-700 admin-dark:text-gray-300 admin-dark:hover:text-white transition-colors cursor-pointer"
          >
            <svg
                ...
                <ul className="list-none space-y-2">
                  {features.map((f, i) => (
                    ...
                    >
                      ...
                      />
                      <p className="text-gray-700 admin-dark:text-gray-300 text-sm sm:text-base">
                        {f}
                      </p>
                    </li>
                  ))}
