...
export default function TopSpendingCustomers({ initDataCustomer }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md shadow-gray-300/50 border border-[#e5e7eb] admin-dark:bg-gray-800 admin-dark:border-gray-700 admin-dark:shadow-gray-900/50">
      {/* Card Header */}
      <div className="p-3 border-b border-gray-200 admin-dark:border-gray-700">
        ...
        >
          <table className="w-full">
            ...
            <thead className="sticky top-0 bg-white admin-dark:bg-gray-800 z-10">
              <tr className="border-b border-gray-300 admin-dark:border-gray-700">
                <th className="text-left text-sm py-3 px-4 font-semibold text-black admin-dark:text-white">
                  STT
                </th>
                <th className="text-left text-sm py-3 px-4 font-semibold text-black admin-dark:text-white">
                  Tên
                ...
                <th className="text-right text-sm py-3 px-4 font-semibold text-black admin-dark:text-white">
                  Đã chi
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              {topCustomers.map((customer, index) => (
                ...
                >
                  <td className="py-3 px-4 text-sm text-gray-700 admin-dark:text-gray-300">
                    {index + 1}
                  </td>
                  <td className="py-3 px-4 text-sm font-medium text-gray-900 admin-dark:text-gray-100">
                    {customer.name}
                  </td>
                  <td className="py-3 px-4 text-sm text-gray-700 admin-dark:text-gray-300">
                    {customer.phone || "N/A"}
                  </td>
                  <td className="py-3 px-4 text-sm text-right font-medium text-gray-900 admin-dark:text-gray-100">
