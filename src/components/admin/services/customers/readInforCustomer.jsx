    ...
    <div className="space-y-6 admin-dark:text-white">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 admin-dark:text-gray-300">
          ...
          <div>
            <span className="font-medium">Ảnh CCCD mặt trước: </span>
            <img
          ...
          <div>
            <span className="font-medium">Ảnh CCCD mặt sau: </span>
            <img
              src={`${import.meta.env.VITE_MAIN_BE_URL}${
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-100 admin-dark:bg-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-center">Số lần đặt</th>
              ...
              <tbody className="bg-white admin-dark:bg-gray-800">
                {sortedBookings.map((b, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center text-gray-900 admin-dark:text-gray-300">
                      {b.count}
                    </td>
                ...
                <tr className="border-t-2 border-gray-300 admin-dark:border-gray-600 font-semibold">
                  <td className="px-4 py-3 text-gray-900 admin-dark:text-white">
                    Tổng cộng
                  </td>
                  <td className="px-4 py-3 text-center">—</td>
                  <td className="px-4 py-3 text-center text-gray-900 admin-dark:text-white">
