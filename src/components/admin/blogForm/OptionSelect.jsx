  ...
  return (
    <div className={cn("relative inline-block w-full", className)} ref={triggerRef}>
      ...
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-md border-2 border-gray-300 bg-white px-3 py-2 text-gray-800 text-sm focus:border-none focus:ring-2 focus:ring-blue-500 cursor-pointer admin-dark:bg-gray-800 admin-dark:border-gray-600"
        type="button"
      ...
      {open && (
        <ul
          ...
          className="absolute z-200 mt-2 h-auto overflow-auto rounded-md border border-gray-200 bg-white text-sm md:text-base font-normal text-gray-700 shadow-md admin-dark:border-gray-700 admin-dark:bg-gray-800 admin-dark:text-white"
        >
          {options.map((opt) => (
            <li
              key={opt.value}
