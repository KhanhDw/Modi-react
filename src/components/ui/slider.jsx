...
function Slider({
  ...
  const themeClasses = {
    light: {
      track: "bg-gray-200",
      range: "bg-blue-500",
      thumb: "bg-white border-blue-500 hover:ring-blue-300",
    },
    dark: {
      track: "bg-gray-700",
      range: "bg-green-400",
      thumb: "bg-gray-900 border-green-400 hover:ring-green-600",
    },
    admin: {
      track: "bg-gray-600",
      range: "bg-yellow-500",
      thumb: "bg-gray-900 border-yellow-500 hover:ring-yellow-400",
    },
  }
