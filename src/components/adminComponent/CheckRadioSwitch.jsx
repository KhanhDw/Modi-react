...
function Checkbox({ checked, onChange, label, disabled }) {
    return (
        <label
            className={`inline-flex items-center cursor-pointer select-none ${disabled
        ...
        >
          ...
          disabled:bg-gray-100 disabled:border-gray-200 admin-dark:disabled:bg-gray-800 admin-dark:disabled:border-gray-700
          relative
        ...
        `}
            ...
            />
            <span className="ml-2 font-semibold text-gray-900 admin-dark:text-gray-100 select-none">{label}</span>
        </label>
    );
}
...
function Radio({ id, name, value, checked, onChange, label, disabled }) {
    return (
        ...
        >
          ...
          h-6 w-6 rounded-full border-2 border-gray-300 admin-dark:border-gray-600
          ${checked ? "border-indigo-600 bg-indigo-600" : ""}
          ${disabled ? "bg-gray-100 border-gray-200 admin-dark:bg-gray-800 admin-dark:border-gray-700" : ""}
          transition-colors duration-200
          relative
        `}
            >
...
function Switch({ label, defaultChecked = false, onChange, disabled = false, color = "indigo" }) {
    ...
    const colors = {
        indigo: {
            bgOn: "bg-indigo-600",
            bgOff: "bg-gray-300 admin-dark:bg-gray-600",
            dotOn: "translate-x-6",
            dotOff: "translate-x-1",
        },
        gray: {
            bgOn: "bg-gray-900 admin-dark:bg-gray-100",
            bgOff: "bg-gray-400 admin-dark:bg-gray-600",
            dotOn: "translate-x-6",
            dotOff: "translate-x-1",
        },
    };
    ...
    return (
        ...
        >
            ...
            <span className="ml-3 text-gray-900 admin-dark:text-gray-100 font-medium select-none">{label}</span>
        </label>
    );
}
...
export default function Demo() {
    ...
    return (
        <div className="p-6 m-4 max-w-xl mx-auto space-y-6 bg-white admin-dark:bg-gray-900 rounded-lg border border-gray-200 admin-dark:border-gray-700">
            {/* Checkbox Section */}
            <section className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 admin-dark:text-gray-100 border-b border-gray-200 admin-dark:border-gray-700 pb-2">
                    Checkbox
                </h3>
            ...
            {/* Radio Section */}
            <section className="space-y-4 border-t border-gray-200 admin-dark:border-gray-700 pt-4">
                <h3 className="text-lg font-semibold text-gray-900 admin-dark:text-gray-100 border-b border-gray-200 admin-dark:border-gray-700 pb-2">
                    Radio Buttons
                </h3>
                <div className="flex gap-6">
            ...
            {/* Switch Section */}
            <section className="space-y-6 border-t border-gray-200 admin-dark:border-gray-700 pt-4">
                <h3 className="text-lg font-semibold text-gray-900 admin-dark:text-gray-100 border-b border-gray-200 admin-dark:border-gray-700 pb-2">
                    Toggle switch input
                </h3>
