    ...
    return (
        <div className="bg-white admin-dark:bg-gray-800 m-2 rounded-2xl p-6 md:p-8 shadow-sm w-full max-w-4xl mx-auto transition-colors duration-300">
            ...
            <div className="mb-4">
                ...
                <p className="text-sm text-gray-500 admin-dark:text-gray-400 mt-1">20 February 2022</p>
            </div>
                    ...
                    <button
                        ...
                        className={`px-4 py-1.5 rounded-full text-sm font-medium transition cursor-pointer
                            ${selected === key
                                ...
                                : 'bg-gray-100 text-gray-500 hover:bg-gray-200 admin-dark:bg-gray-700 admin-dark:text-gray-300 admin-dark:hover:bg-gray-600'
                            }`}
                    >
