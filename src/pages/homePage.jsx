...
function HomePage({ activeSidebarHeader }) {
    ...
    return (
        <div className={`${activeSidebarHeader ? 'overflow-hidden' : ''}  w-full h-full md:p-4 mx-auto flex flex-col items-center justify-center bg-white dark:bg-gray-800`}>
            <BannerSilder />
            <BaseModi />
            <ThreeCardBusiness />
            <ServiceModi />
...
function ServiceModi() {
    ...
    const services = [
        ...
        { title: t("home.serviceModi.services.6.title") },
        { title: t("home.serviceModi.services.7.title") },
    ]
