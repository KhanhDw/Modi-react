...
const TermsOfServicePage = () => {
  ...
  const otherItems = t('TermsOfServicePage.sections.otherItems', { returnObjects: true }) || [];
  const registrationItems = t('TermsOfServicePage.sections.membershipRegistration.items', { returnObjects: true }) || [];
  const prohibitionItems = t('TermsOfServicePage.sections.prohibitions.items', { returnObjects: true }) || [];
    ...
    <div className="bg-white dark:bg-slate-900 text-gray-800 dark:text-gray-300 font-sans min-h-screen p-4 sm:p-6 md:p-8">
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 sm:p-8 md:p-10">
        ...
        <header className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2">{t('TermsOfServicePage.header.lastUpdated')}</p>
        </header>
