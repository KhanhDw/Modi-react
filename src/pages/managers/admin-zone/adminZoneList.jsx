...
export default function AdminZoneList() {
    ...
    return (
        <div>
            <div className="mx-auto rounded-xl border-gray-200 admin-dark:border-gray-700 bg-white admin-dark:bg-gray-900 p-6 transition-all duration-500 ease-in-out">
                ...
                <div className="flex flex-wrap items-stretch justify-between gap-4 mb-6">
                    {/* Tiêu đề */}
                    <h2 className="text-xl font-semibold text-gray-900 admin-dark:text-white flex-grow sm:flex-grow-0 whitespace-nowrap">
                        Quản lý Tài khoản nhân viên
                    </h2>

                    {/* Ô tìm kiếm */}
                    <div className="relative w-full sm:w-auto flex-grow sm:flex-grow-0 sm:min-w-[250px]">
                        <FiSearch
                    ...
                    {/* Nút Thêm mới */}
                    <button
                        onClick={() => navigate("/managers/admin-zone/new")}
        ...
        px-3 py-2 rounded-lg transition text-sm sm:text-base whitespace-nowrap cursor-pointer"
                        type="button"
                    >
                        + Thêm mới
                    </button>
                                    ...
                                    >
                                        ...
                                        <td className="py-3 px-6 text-gray-700 admin-dark:text-gray-300 text-center">
                                            <div className="flex justify-center gap-4">
                                                ...
                                                <button
                                                    title="Chỉnh sửa"
                                                    onClick={() => navigate('/managers/admin-zone/edit', { state: { user: item } })}
