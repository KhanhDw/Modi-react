    ...
    if (!userData) {
        return (
            <div className="min-h-screen flex items-center justify-center text-center px-4">
                <div className="text-gray-700 admin-dark:text-gray-200">
                    <p className="text-lg font-semibold">Không tìm thấy dữ liệu người dùng.</p>
                    <button
                        onClick={() => navigate('/managers/admin-zone')}
