...
export default function EditPage() {
    const { posts, formData, setFormData, handleEditPost, setEditingPost } = useOutletContext();
    const { id } = useParams();
    ...
    }, [post, navigate, setEditingPost, setFormData]);
            ...
            <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-6">
                    ...
                    <div className="bg-gray-50 admin-dark:bg-gray-900 py-4 rounded-lg shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                ...
                                >
                                    <SelectTrigger className="w-full bg-white admin-dark:bg-gray-600 admin-dark:text-white 
                                                              admin-dark:border-gray-500 border-gray-300 
                                                              focus:ring-2 focus:ring-blue-500 admin-dark:focus:ring-blue-600 rounded-md">
                                        <SelectValue placeholder="Chọn mạng xã hội" />
                                    </SelectTrigger>
                                    <SelectContent className="bg-white text-black admin-dark:bg-gray-900 admin-dark:text-black">
                                        ...
                                        <Button
                                            type="button"
                                            className="mt-2 px-2 w-full flex items-center hover:bg-gray-300  
                                                       admin-dark:hover:bg-gray-700 admin-dark:hover:text-yellow-600"
                                        >
                ...
                <div className="box-border col-span-2 p-4 overflow-hidden bg-gray-50 admin-dark:bg-gray-800 rounded-lg shadow-sm">
                    ...
                    <Textarea
                        ...
                        rows={6}
                        className="px-4 py-2 w-full h-11/12 overflow-y-auto bg-white admin-dark:bg-gray-600 
                                   admin-dark:text-white admin-dark:border-gray-500 border-gray-300 
                                   focus:ring-2 focus:ring-blue-500 admin-dark:focus:ring-blue-600 rounded-md"
                    />
                </div>
            </div>
