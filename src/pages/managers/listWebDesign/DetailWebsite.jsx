import { LogOut , ArrowLeft, Edit, Calendar, Tag, Folder } from "lucide-react"
    ...
    <div className="flex items-center justify-between mb-8">
      <div className="flex items-center gap-4">
        <Button
          variant="ghost"
          onClick={onBack}
          className="flex items-center gap-2  text-gray-700 hover:text-gray-800 admin-dark:text-gray-200 hover:bg-gray-100 admin-dark:hover:bg-gray-800"
        >
      ...
      <Button
        onClick={onEdit}
        className="flex items-center gap-2 bg-primary hover:bg-primary/90 admin-dark:bg-blue-600 admin-dark:hover:bg-blue-500"
      >
        Xuất bản
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-white admin-dark:bg-gray-900 border border-gray-200 admin-dark:border-gray-700">
          ...
          <CardContent className="space-y-3">
            ...
            {/* <Button
              variant="outline"
              className="w-full bg-transparent border-gray-300 admin-dark:border-gray-600 admin-dark:bg-gray-800"
            >
              Xuất mẫu
            </Button> */}
            ...
            <Button
              variant="outline"
              className="w-full bg-transparent text-gray-800 border-gray-300 admin-dark:border-gray-600 admin-dark:bg-gray-800"
            >
              Github dự án
            </Button>
          </CardContent>
