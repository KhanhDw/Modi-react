...
import { FileText, Plus, Pencil, GripVertical, Trash2 } from "lucide-react";
    ...
    return (
        <Card className="bg-white admin-dark:bg-gray-900">
            ...
            <CardHeader className="pb-4 flex justify-between items-center">
                ...
                <CardTitle className="flex items-center gap-2 text-gray-800 admin-dark:text-gray-100 min-w-0">
