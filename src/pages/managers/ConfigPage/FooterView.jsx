...
export default function FooterView({ data, services = [], socials = [], privacy = [], boCongThuong, lang }) {
    const { t } = useLanguage();
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {boCongThuong?.enable && boCongThuong?.url && (
                                <div className="flex items-center gap-3">
                                    <a href={boCongThuong.url} target="_blank" rel="noopener noreferrer">
                                        <img
                            ...
                            <div className="grid grid-cols-2 gap-x-8">
                                ...
                                <ul className="space-y-3">
                                    {privacy_statement.slice(Math.ceil(privacy_statement.length / 2)).map((service, index) => (
                                        <li key={index + 100} className="transition-all duration-200 hover:text-green-400 xs:text-sm md:text-md 3xl:text-xl">
                                            <Link to={service.link}>{service.title}</Link>
                                        </li>
                                    ))}
                                </ul>
