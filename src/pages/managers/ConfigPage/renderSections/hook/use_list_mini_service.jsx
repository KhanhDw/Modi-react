...
export const getMiniServiceById = async (id) => {
    try {
        ...
        if (result.success) {
            ...
            throw new Error(result.message || `Failed to get mini service with id ${id}`);
        }
    } catch (error) {
...
export const getMiniServicesByStageId = async (stageId) => {
    try {
        ...
        if (result.success) {
            ...
            throw new Error(result.message || `Failed to get mini services for stage id ${stageId}`);
        }
    } catch (error) {
        console.error(`Error getMiniServicesByStageId with stageId ${stageId}:`, error);
        throw error;
    }
};
...
export const updateMiniService = async (id, miniServiceData) => {
    try {
        ...
        if (result.success) {
            ...
            throw new Error(result.message || `Failed to update mini service with id ${id}`);
        }
    } catch (error) {
...
export const deleteMiniService = async (id) => {
    try {
        ...
        if (result.success) {
            ...
            throw new Error(result.message || `Failed to delete mini service with id ${id}`);
        }
    } catch (error) {
