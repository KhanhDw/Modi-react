import MarketingPageV1 from "@/pages/managers/marketing/marketingPageFull"
...
export default function MarketingPage() {
  ...
  return (
    <div className=" bg-gray-50 admin-dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <DialogContent className=" max-w-4xl  bg-white admin-dark:bg-gray-800">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="p">
                    <Label htmlFor="add-title" className="text-gray-700 admin-dark:text-gray-200">
                      Tiêu đề
                    </Label>
                    <Input
                      id="add-title"
                  ...
                  <div className="p">
                    <Label htmlFor="add-author" className="text-gray-700 admin-dark:text-gray-200">
                      Tác giả
                    </Label>
                    <Input
                      id="add-author"
                ...
                <div className="p">
                  <Label htmlFor="add-content" className="text-gray-700 admin-dark:text-gray-200">
                    Nội dung
                  </Label>
                  <Textarea
                    id="add-content"
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="p">
                    <Label className="text-gray-700 admin-dark:text-gray-200">Platform</Label>
                    <Select
                  ...
                  <div className="p">
                    <Label className="text-gray-700 admin-dark:text-gray-200">Trạng thái</Label>
                    <Select
                  ...
                  <div className="p">
                    <Label className="text-gray-700 admin-dark:text-gray-200">Tags</Label>
                    <Input
                      value={formData.tags}
                ...
                <div className="p">
                  <Label className="text-gray-700 admin-dark:text-gray-200">URL Hình ảnh</Label>
                  <Input
            ...
            <Table>
              <TableHeader>
                <TableRow className=" border-b border-gray-200 admin-dark:border-gray-700">
                  <TableHead className="text-gray-900 admin-dark:text-white">Tiêu đề</TableHead>
                  <TableHead className="text-gray-900 admin-dark:text-white">Platform</TableHead>
                  <TableHead className="text-gray-900 admin-dark:text-white">Tác giả</TableHead>
                  <TableHead className="text-gray-900 admin-dark:text-white">Trạng thái</TableHead>
                  <TableHead className="text-gray-900 admin-dark:text-white">Ngày tạo</TableHead>
                  <TableHead className="text-gray-900 admin-dark:text-white">Engagement</TableHead>
                  <TableHead className="text-right text-gray-900 admin-dark:text-white">Thao tác</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-2xl bg-white admin-dark:bg-gray-800">
            <DialogHeader>
              <DialogTitle className="text-gray-900 admin-dark:text-white">Chỉnh sửa bài viết</DialogTitle>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="edit-title" className="text-gray-700 admin-dark:text-gray-200">
                    Tiêu đề
                  </Label>
                  <Input
                    id="edit-title"
                ...
                <div>
                  <Label htmlFor="edit-author" className="text-gray-700 admin-dark:text-gray-200">
                    Tác giả
                  </Label>
                  <Input
                    id="edit-author"
              ...
              <div>
                <Label htmlFor="edit-content" className="text-gray-700 admin-dark:text-gray-200">
                  Nội dung
                </Label>
                <Textarea
                  id="edit-content"
