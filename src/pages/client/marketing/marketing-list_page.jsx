...
import ArticlesList from "@/pages/client/marketing/articles-list";
...
export default function MarketingPage() {
  ...
  const fetchArticles = async (term = "") => {
    try {
      ...
      const blogsPublis = data.data.filter(
        (post) => post.status === "published"
      );
      const sortData = blogsPublis.sort(
          ...
          <div className="flex flex-col text-center md:text-left">
            ...
            <p className="text-sm sm:text-base text-muted-foreground dark:text-gray-400 mb-3">
              {lang == "vi"
                ...
                : "An SEO-friendly business website helps you reach thousands of customers and stay ahead of the competition"}
            </p>
