...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 my-30">
      {/* Modal */}
      {formSubmitted && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white px-6 py-8 rounded-xl shadow-xl text-center max-w-sm w-full">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="flex gap-2 w-full">
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="flex-1 h-12 px-2 w-2/3 border rounded-lg"
                    />
                    <div className="flex-shrink-0 w-1/3 bg-black text-white px- py-2 rounded-lg font-mono text-lg flex items-center justify-center">
                      {captcha}
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:sticky lg:top-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden h-[600px] lg:h-[800px]">
              <iframe
                ...
                title="Bản đồ Công ty Ty Phú Việt"
              ></iframe>
            </div>
          </div>
        </div>
